...
public class JanelaNovaVenda extends JFrame {
	...
	public JanelaNovaVenda() {
		...
		panelProdutos.setBorder(new TitledBorder(new MatteBorder(1, 1, 1, 1, (Color) new Color(0, 0, 0)), "Produtos", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panelVenda.setBorder(new TitledBorder(new LineBorder(new Color(0, 0, 0)), "Detalhes da Venda", TitledBorder.LEADING, TitledBorder.TOP, null, null));
